              ...
              <div class="box-body">
				...
				<div class="col-xs-12 col-md-12" ">
                    ...
                    <?php $ct = 0; foreach ($stock_data as $kk => $v): ?>
                        <div class='mappedFieldTemplate' id='mappedFieldTemplate_<?php echo $ct +1; ?>' id='mappedFieldTemplate_<?php echo $ct +1; ?>' >
                        	<div class="form-group col-md-5 col-xs-12">
                              <label for="product_id[]">Product name</label>
                              <select class="form-control select_group  fieldLabel" id="product_id_<?php echo $ct +1; ?>" data-row-id="row_<?php echo $ct +1; ?>"  name="product_id[]">
                              	<option value=""></option>
                                <?php foreach ($products as $k => $v): ?>
                                  <option value="<?php echo $v['id'] ?>"<?php if($v['id'] == $stock_data[$kk]['product_id']): echo "selected"; endif;?>><?php echo $v['name'] ?></option>
                                <?php endforeach ?>
                              </select>
                            </div>
