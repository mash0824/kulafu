      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
            ...
            <div class="box-body">
              ...
              <div>
              <br/>
              <a href="<?php echo base_url('lists-of-products/'.$warehouseNameLink.'/'.$store_id) ?>" class="btn btn-warning">Back</a>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('products/removeProductStore/'.$product_data['id'].'/'.$store_id) ?>" method="get" id="removeForm">
...
<?php endif; ?>
  ...
  var base_url = "<?php echo base_url(); ?>";
    ...
    // remove functions 
    function removeFunc(id,storeid)
    {
      if(id) {
          ...
          $.ajax({
            ...
            success:function(response) {
              if(response.success === true) {
                ...
                var delay = 1000; 
                setTimeout(function(){ window.location = '/<?php echo 'lists-of-products/'.$warehouseNameLink.'/'.$store_id; ?>'; }, delay);
