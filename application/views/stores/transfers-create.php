				...
				<div class="col-xs-12 col-md-12" ">
					<div class="col-xs-12">
                        <div class="form-group col-md-4 col-xs-12">
        					<label for="display_id">Transfer ID</label>
                          <input type="text" class="form-control" id="display_id" name="display_id" placeholder="eg. TR-MO-000001" autocomplete="off" value="<?php echo $display_id;?>" disabled  />
                        </div>
                        ...
                        <div class='col-xs-12 mappedFieldTemplate' id='mappedFieldTemplate_0' id='mappedFieldTemplate_0' >
                        	<div class="form-group col-md-4 col-xs-12">
                              ...
                              <select class="form-control select_group  prodLabel" id="product_id_0" data-row-id="row_0"  name="product_id[]" required>
                                ...
                                ?>
                                  <option value="<?php echo $v['product_id'] ?>" data-less="<?php echo intval($v['less_stock']) ?>" data-cost="<?php echo $v['cost'] ?>" data-price="<?php echo $v['sale_price'] ?>" data-stock="<?php echo $stock_count ?>" data-unit="<?php echo $v['unit_id'] ?>"><?php echo $v['name'] ?></option>
                                <?php endforeach ?>
                              </select>
                            </div>
                            <div class="form-group col-md-2 col-xs-12">
                            	...
                            	<input type="hidden" class="form-control lessLabel" id="less_stock_0" name="less_stock[]" data-row-id="row_0" placeholder="eg. 100" autocomplete="off" value=""  />
