...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1 class="margin50">
      Edit Delivery #<?php echo $display_id;?>
    </h1>
  </section>
        ...
        <div class="box">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
    				...
    				<div class="col-xs-12">
    					<div class="form-group col-md-8 col-xs-12">
                          <label for="address">Delivery Address</label>
                  		  <textarea type="text" class="form-control" id="address" name="address" placeholder="Enter Delivery Address" autocomplete="off" required><?php echo $tdata['address'];?></textarea>
                        </div>
    				</div>
              ...
              <div class="box-footer margin50">
                ...
                <input type="checkbox" id="checkme" name="checkme" value="1" <?php if($tdata['transaction_status'] == "delivered"): echo "checked";  endif;?> /> <label for="checkme">Mark as delivered</label> <br/>
