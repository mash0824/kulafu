				...
				<div class="col-xs-12 col-md-12" ">
					<div class="col-xs-12">
                        <div class="form-group col-md-4 col-xs-12">
        					<label for="display_id">Withdrawal ID</label>
                          <input type="text" class="form-control" id="display_id" name="display_id" placeholder="eg. WD-MO-000001" autocomplete="off" value="<?php echo $display_id;?>" disabled  />
                        </div>
