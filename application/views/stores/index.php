  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <?php if(in_array('createWarehouse', $user_permission)): ?>
              ...
              <table id="customerTable" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php if($warehouse_data): ?>                  
                    <?php foreach ($warehouse_data as $k => $v): ?>
                      <tr>
                        <td><?php echo $v['warehouse_disp_id']; ?></td>
                        <td><?php echo $v['name']; ?></td>
                        <td>
                          <?php if(in_array('updateWarehouse', $user_permission)): ?>
                          <a href="<?php echo base_url('warehouse/edit/'.$v['id']) ?>" class="greenlink">edit</a>  
                          <?php endif; ?>&nbsp;
                          <?php if(in_array('deleteWarehouse', $user_permission)): ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('warehouses/remove/') ?>" method="get" id="removeForm">
          ...
          $.ajax({
            ...
            success:function(response) {
              ...
              if(response.success === true) {
                ...
                var delay = 1000; 
                setTimeout(function(){ window.location = '/warehouses'; }, delay);
              } else {
