...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1 class="margin50">
      Edit Pickup #<?php echo $display_id;?>
    </h1>
  </section>
        ...
        <div class="box">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
				...
				<div class="col-xs-12 col-md-12" ">
					<div class="col-xs-12">
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                          ...
                          <input type="number" class="form-control" id="po_number" name="po_number" placeholder="eg. 132456987" autocomplete="off" value="<?php echo $tdata['po_number'];?>"  required />
                        </div>
    				...
    				<div class="col-xs-12">
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                          ...
                          <select class="form-control select_group" id="customer_id" name="customer_id" required>
                              ...
                              <option value="<?php echo $v['id'] ?>" <?php if($v['id'] == $tdata['customer_id']): echo "selected"; endif;?> ><?php echo $v['customer_name'] ?></option>
                            <?php endforeach ?>
                          </select>
                        </div>
    				</div>
                        ...
                        <div class='col-xs-12 mappedFieldTemplate' id='mappedFieldTemplate_<?php echo $ct;?>' id='mappedFieldTemplate_<?php echo $ct;?>' >
                        	<div class="form-group col-md-4 col-xs-12">
                              ...
                              <select class="form-control select_group  prodLabel" id="product_id_<?php echo $ct;?>" data-row-id="row_<?php echo $ct;?>"  name="product_id[]" required  <?php if($value['is_prod_deleted'] == 1):?>disabled<?php endif;?>>
                                ...
                                ?>
                                <option value="<?php echo $value['product_id'] ?>" selected="selected"   data-cost="<?php echo $value['cost']; ?>" data-price="<?php echo $value['sale_price']; ?>" data-stock="<?php echo $stock_count; ?>" data-unit="<?php echo $value['unit_id'] ?>"><?php echo $value['product_name'] ?></option>
                                <?php     
                                }
                                else {
                                ...
                                ?>
                                  <option value="<?php echo $v['product_id'] ?>" <?php if($value['product_id'] == $v['product_id']): echo "selected"; endif;?> data-cost="<?php echo $v['cost']; ?>" data-price="<?php echo $v['sale_price']; ?>" data-stock="<?php echo $stock_count; ?>" data-unit="<?php echo $v['unit_id'] ?>"><?php echo $v['name'] ?></option>
                                <?php endforeach ?>
                                <?php } ?>
                              </select>
                            </div>
                            ...
                            <div class="form-group col-md-2 col-xs-12">
                              ...
                              <input type="number" min="0" max="" class="form-control quantityLabel" id="quantity_<?php echo $ct;?>"  onkeypress="return isNumber(event)" name="quantity[]" data-row-id="row_0" placeholder="eg. 100" autocomplete="off" value="<?php echo $value['quantity'];?>" required  <?php if($value['is_prod_deleted'] == 1):?>disabled<?php endif;?> />
                            </div>
                            <div class="form-group col-md-2 col-xs-12">
                            ...
                            <div class="form-group col-md-2 col-xs-12">
                              ...
                              <input type="text" class="form-control salesLabel" id="sales_amount_<?php echo $ct;?>" data-row-id="row_<?php echo $ct;?>" name="sales_amount[]" placeholder="eg.0.00" autocomplete="off" value="<?php echo $value['sale_amount'];?>" disabled /> 
                            </div>
                    ...
                    <div class="col-xs-12">
                    	<div class="form-group col-md-2 col-xs-12">
                          ...
                          <input type="text" class="form-control" id="total_sales" name="total_sales" data-row-id="row_0" placeholder="0.00" autocomplete="off" value="<?php echo $total; ?>" disabled />
                        </div>
                    </div>
                    <div class="col-xs-12">
                    	<div class="form-group col-md-2 col-xs-12">
                          <label for="notes">Additional Notes</label>
                          <input type="text" class="form-control" id="notes" name="notes" data-row-id="row_0" placeholder="Additional Notes" autocomplete="off" value="<?php echo $tdata['notes'];?>"  />
                        </div>
                    </div>
              ...
              <div class="box-footer margin50">
                ...
                <input type="checkbox" id="checkme" name="checkme" value="1" <?php if($tdata['transaction_status'] == "delivered"): echo "checked";  endif;?> /> <label for="checkme">Mark as picked up</label> <br/>
                <button type="submit" class="btn btn-primary">Update Pickup Order</button>
                <a href="<?php echo base_url('/pickups/'.strtolower(str_replace(" ", "-", $warehouse_data['name'])).'/'.$warehouse_data['id']) ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
