        ...
        <div class="box">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
				...
				<div class="col-xs-12 col-md-12" ">
					<div class="col-xs-12">
                        <div class="form-group col-md-4 col-xs-12">
        					<label for="display_id">Pickup ID</label>
                          <input type="text" class="form-control" id="display_id" name="display_id" placeholder="eg. PK-MO-000001" autocomplete="off" value="<?php echo $display_id;?>" disabled  />
                        </div>
                        <div class="form-group col-md-4 col-xs-12">
              ...
              <div class="box-footer margin50">
                ...
                <input type="checkbox" id="checkme" name="checkme" value="1" /> Mark as picked up <br/>
                <button type="submit" class="btn btn-primary">Create Pickup Order</button>
